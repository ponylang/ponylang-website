...
There were no office hours occurred this week. Please note that the time of Office Hours has changed; refer to the calendar (link below) to keep track of the new time.
...
This week we are highlighting a much larger topic: [types](https://tutorial.ponylang.io/types/)!
